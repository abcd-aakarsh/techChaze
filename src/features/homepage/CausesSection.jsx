  ...
  return (
    <div className="py-[20px] px-[20px] lg:p-[110px] lg:pt-0 w-full bg-hero-color">
      <div className="text-center">
        <h3 className="font-manuale font-semibold pb-5 text-[40px] leading-tight ">
          Urgent Causes
        </h3>
        <p className="font-montserrat font-medium pb-5 lg:pb-8 text-xl leading-normal">
          Supporting urgent causes, changing lives
        </p>
      </div>
      <div className="flex justify-center items-center flex-col md:flex-row ">
        <div className="grid grid-cols-1 lg:grid-cols-3 items-center justify-center  gap-6 mb-4 lg:gap-10">
          <CausesCard
            img={p1}
