  ...
  return (
    <>
      <div className="p-5 relative flex items-center max-w-[1178px] mx-auto justify-center min-h-[600px]">
        <div className="bg-button-color w-full p-8 md:p-12 rounded-[40px] ">
      ...
      <div className="bg-white absolute bottom-0 sm:bottom-[80px] md:bottom-[150px] lg:bottom-[125px] -z-20 h-[330px] sm:h-[210px] md:h-[170px] w-full"></div>
    </>
  );
};
